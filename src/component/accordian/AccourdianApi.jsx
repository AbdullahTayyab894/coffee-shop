export const data = [
    {
      id: 1,
      title: "How to brew the ultimate drink?",
      content: "Netflix is a streaming service that offers a wide variety of award-winning TV shows, movies, anime, documentaries, and more on thousands of internet-connected devices. You can watch as much as you want, whenever you want without a single commercial all for one low monthly price. There's always something new to discover and new TV shows and movies are added every week!",
    },
    {
      id: 2,
      title: "Tells us Preparation Methods?",
      content: "Watch Netflix on your smartphone, tablet, Smart TV, laptop, or streaming device, all for one fixed monthly fee. Plans range from Rs250 to Rs1,100 a month. No extra costs, no contracts.",
    },
    {
      id: 3,
      title: "what is the Peripherals and Secondary Storage?",
    ...
    {
      id: 4,
      title: "what is the Coffee Recipes?",
    ...
    {
      id: 5,
      title: "Which Flavoring is include?",
    ...
    {
      id: 6,
      title: "What is the best temperature to brew coffee?",
